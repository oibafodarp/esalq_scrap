...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_SECURITY_NEWS.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT Title AS TEXTO FROM TAB_SECURITY_NEWS WHERE DateTime like '2022%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_securitynews.png")
