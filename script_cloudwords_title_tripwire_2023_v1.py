...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_TRIPWIRE.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT titulo as TEXTO FROM TAB_TRIPWIRE WHERE CAST(substr(data_publicacao, -4, 4) AS INTEGER) = '2022'; "
...
custom_stopwords = ['b', 'https', 'an', 'with', 'is', 'not', 'since', 'were', 'have', 'more', 'some', 'any', 'us',
    ...
    'target', 'targeting', 'attack', 'attacks', 'targeted', 'CISA', 'CISA Update', 'CISA Release', 'Release'
...
wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_tripwire.png")
