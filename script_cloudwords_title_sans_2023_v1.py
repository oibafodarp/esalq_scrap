...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_SANS.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT Title AS TEXTO FROM TAB_SANS WHERE 'Date Published' like '2022%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_sans.png")
