...
query = "SELECT DISTINCT Title AS TEXTO FROM TAB_COMPUTERWEEK WHERE published LIKE '2022%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_computerworld.png")
