...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_HACKERNEWS.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT TITLE FROM TAB_HACKERNEWS WHERE DATETIME LIKE '%2024' "
...
if 'TITLE' in df.columns:
    df['TITULO'] = df['TITLE'].apply(remove_url)
    df = df[['TITULO']]  # Manter apenas a coluna 'TITULO'
else:
    raise KeyError("A coluna 'TITLE' não está presente no DataFrame.")
...
wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2024_hackernews.png")
