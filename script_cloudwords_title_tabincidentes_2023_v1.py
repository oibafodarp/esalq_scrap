...
query = "SELECT DISTINCT TITULO AS TEXTO FROM TAB_INCIDENTES WHERE DATA_PUBLICACAO like '2022%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_tabincidentes.png")
