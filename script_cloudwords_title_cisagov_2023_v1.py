...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_CISAgov.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT TextoLink as TEXTO FROM TAB_CISAgov WHERE DataPagina LIKE '2022%'; "
...
wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_cisagov.png")
