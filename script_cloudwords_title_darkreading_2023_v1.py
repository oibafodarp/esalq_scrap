...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_DARKREADING.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT Título AS TEXTO FROM TAB_DARKREADING WHERE Data like '%2022'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_darkreading.png")
