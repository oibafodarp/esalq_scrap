...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_TWITTER.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT texto AS TEXTO FROM TAB_TWITTER WHERE data_datetime like '2024%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2024_twitter.png")
