...
query = "SELECT DISTINCT title AS TEXTO FROM TAB_NEWSapi WHERE publishedAt like '2023%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2023_tabnewsapi.png")
