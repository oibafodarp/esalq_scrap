...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_TI_INSIDE.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT TITULO AS TEXTO FROM TAB_TI_INSIDE WHERE DateTime like '2022%'; "
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_tiinside.png")
