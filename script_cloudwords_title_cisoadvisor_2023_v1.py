...
conn = sqlite3.connect('/home/fabio/BD_INTELLIGENCE/BD_CISO.db')

# Consulta SQL para obter os títulos
query = "SELECT DISTINCT TextoLink AS TEXTO FROM TAB_CISOADVISOR WHERE DataPagina like '%2022'; "
...
stop_words = set(stopwords.words('portuguese'))  # Pode ser necessário ajustar para o idioma correto
...
if not filtered_words:
    ...
    wordcloud.to_file("/home/fabio/pln/nuvem_de_palavras_2022_cisoadvisor.png")
